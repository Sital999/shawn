 ...
 void beg()
{
	...
	cout<<"Do u intend to add more products?(Y or N)"<<endl;
	cin>>x;
	if(x=='Y'||x=='y'){
		beg();
	}
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	int linear_search(int id)                     //    for search item in list
 {
 	int count=1;
 	struct node *p=head;
 	while(p!=NULL)
...
////////////////////////////////////////////////////////////////////////
	...
	pos=linear_search(id);                        //   for check weather desire node is exist or not
	if(pos<=count){
...
void search_display(int pID){
	node *temp = bst_search(root,pID);

	if(temp== 0){
		cout<<"No Products found with this ID"<<endl;
		return;
	}
	...
	cout<<"ID\t\tProduct Name\t\t Price\t\tQuantity\n";
	cout<<"=================================================================|\n";
	cout<<temp->ID<<"\t\t"<<temp->proName<<"\t\t\t"<<temp->prePrice<<"\t\t"<<check(temp->quantity)<<"\n";
}
...
void buy()
{
 ...
 /////////////////////////////////////////////////////////////////////////////////////////
	...
	cout<<"\t\t     Enter 4 for Search Existing product"<<endl;
	cout<<"\t\t     Enter 5 for Delete a particular product item"<<endl;
	cout<<"\t\t     Enter 6 for Customers List "<<endl;
	cout<<"\t\t     Enter 7 for Dequeue customer"<<endl;
...
int main()
{
     ...
     for(int i=0;i<=51;i++)
     {
		...
		system("color 01");     //  for console color
	gotoxy(17,5);
	cout<<"--------------------------------------------------"<<endl;
	gotoxy(17,7);
	cout<<"||----------------------            Department Store Management System          -----------------------||"<<endl;
	gotoxy(17,9);
	cout<<"--------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> Bibha Sthapit <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<">>>----Project Developed By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"Sanjay Bhandari"<<endl;
   	gotoxy(22,16);
   	cout<<"Shital Nagarkoti"<<endl;
   	gotoxy(22,17);
   	cout<<"Niraj Shrestha"<<endl<<endl;
	system("pause");
	system("cls");
	system("color 01"); 
